...
// Function. Evento creado/publicado/cancelado, invitado agregado/eliminado
// desde la UI normal e invitación enviada ocurren hoy vía escritura directa
// del frontend a Firestore — no están cubiertos acá (ver
// docs/backend-observability.md, sección "Brechas conocidas").
