...
// cargado tumbe silenciosamente el login, la subida a Cloudinary o Sentry —
// no reemplaza corregir el secret en sí, pero evita que un espacio o salto
// de línea de más rompa la app hasta que se corrija.
