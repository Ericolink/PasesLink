            ...
            return (
              ...
              >
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1.5 shrink-0 bg-[#25D366] text-white rounded-lg px-3 py-2.5 text-xs font-medium hover:opacity-90 transition-opacity"
                >
