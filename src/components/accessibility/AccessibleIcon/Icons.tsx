...
export function IconGithub({ className = 'w-4 h-4' }: IconProps) {
  // viewBox 24×24 (no el 16×16 nativo del ícono) para que ocupe el mismo
  // peso visual que el resto de los íconos de marca a igual className (ej.
  // IconInstagram, contiguo en Footer.tsx) — hallazgo X8 de la auditoría.
...
// Único ícono "de marca" con sus 4 colores propios en vez de currentColor —
// antes copiado inline en Login/Register/Profile/GuestSignupPrompt (4 veces
...
// ConcessionsManager (link "Menú" de EventDetail, encabezado del panel).
...
// MaintenancePage y su toggle en /admin (MaintenanceModePanel).
export function IconTool({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} {...base}>
