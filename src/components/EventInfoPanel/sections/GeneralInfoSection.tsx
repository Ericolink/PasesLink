...
export function GeneralInfoSection({ event, guest }: Props) {
  ...
  return (
    <EventInfoSection id="general" icon={<IconInfo className="w-4 h-4" />} title="Información general" defaultExpanded>
