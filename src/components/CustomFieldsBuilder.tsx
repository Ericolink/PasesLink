...
export function CustomFieldsBuilder({ fields, onChange }: Props) {
  ...
  return (
    <div className="space-y-2">
      {fields.map((field) => (
        <div key={field.id} className="flex items-center gap-2 bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2">
          <input
            type="text"
            value={field.label}
          ...
          <select
            ...
            className="border border-gray-300 dark:border-gray-600 rounded-md px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary bg-white dark:bg-gray-800"
          >
