...
export function ReportModal({
  ...
  return createPortal(
    ...
    >
      ...
      >
        <div className="flex items-center justify-between gap-3 px-6 pt-5 pb-3 border-b border-gray-100 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white flex items-center gap-2">
            <IconFlag className="w-4 h-4 text-red-500" />
            Reportar {contentType === 'comment' ? 'comentario' : 'foto'}
          </h2>
          <button onClick={handleClose} aria-label="Cerrar" className="shrink-0 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200">
        ...
        {!user ? (
          ...
          <div className="px-6 py-8 text-center space-y-2 animate-fade-in">
