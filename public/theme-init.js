...
// regla de "default = dark si no hay preferencia guardada" DEBE coincidir
// con getStoredPreference() en src/contexts/ThemeContext.tsx.
(function () {
  try {
    ...
    else if (pref === 'system') isDark = window.matchMedia('(prefers-color-scheme: dark)').matches
    else isDark = true
